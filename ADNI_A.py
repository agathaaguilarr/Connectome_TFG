...
# ==========================================================================
base_folder = "C:/Users/AGATHA/Desktop/4t GEB/TFG/dades"
# ==========================================================================
# ==========================================================================
# ==========================================================================
...
def loadBurden(subject, modality, baseFolder, normalize=True):
    pet_path = baseFolder + "/PET_loads/PET_loads/"+subject+"/PET_PVC_MG/" + modality
...
def loadSubjectData(subject, correcSCMatrix=True, normalizeBurden=True):
    sc_folder = base_folder + '/connectomes/connectomes/'+subject+"/DWI_processing/"
    SC = np.loadtxt(sc_folder + "connectome_weights.csv")
    if correcSCMatrix:
        SCnorm = correctSC(SC)
    else:
    ...
    fMRI_path = base_folder+"/fMRI/fMRI/"+subject+"/MNINonLinear/Results/Restingstate/"
    series = np.loadtxt(fMRI_path+subject+"_Restingstate_Atlas_MSMAll_hp2000_clean.ptseries.txt")

    return SCnorm, abeta_burden, tau_burden, series
...
subjects = [os.path.basename(f.path) for f in os.scandir(base_folder+"/connectomes/connectomes/") if f.is_dir()]
...
class ADNI_A(DataLoader):
    ...
    def get_AvgSC_ctrl(self, normalized=None):
        avgMatrix = computeAvgSC_HC_Matrix(classification, base_folder+"/connectomes/connectomes/")
    ...
    def get_parcellation(self):
        return set_up_Glasser360_cortex(base_folder)
...
if __name__ == '__main__':
    ...
    print('done! ;-)')
    timeseries_s1 =  s1['002_S_0413']['timeseries']
    print(timeseries_s1)
    # ================================================================================================================
# ================================================================================================================
# ================================================================================================================EOF